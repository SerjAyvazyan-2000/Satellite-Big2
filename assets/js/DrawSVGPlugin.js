...
!function (e, t) {
    ...
    function F(e) {
        ...
        var g = n || {x: 0, y: 0, width: 0, height: 0}, z = g.x, y = g.y, _ = g.width, m = g.height;
    ...
    function G(e, t) {
        ...
        t = t || F(e) + 1;
        var n = f.getComputedStyle(e), r = n.strokeDasharray || "", i = q(n.strokeDashoffset), o = r.indexOf(",");
        return o < 0 && (o = r.indexOf(" ")), t < (r = o < 0 ? t : q(r.substr(0, o))) && (r = t), [-i || 0, r - i || 0]
    }

    function H() {
        l() && (f = window, h = o = m(), x = o.utils.toArray, c = o.core.getStyleSaver, g = o.core.reverting || function () {
        }, d = -1 !== ((f.navigator || {}).userAgent || "").indexOf("Edge"))
    }

    var o, x, f, d, h, k, c, g, b = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
        P = {rect: ["width", "height"], circle: ["r", "r"], ellipse: ["rx", "ry"], line: ["x2", "y2"]}, M = Math.sqrt,
        a = "DrawSVGPlugin", y = z(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        _ = z(103, 115, 97, 112, 46, 99, 111, 109), S = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, O = function (e) {
            ...
            }, 50); -1 < --i;) if (-1 !== e.indexOf(r[i])) return !0;
            ...
            version: "3.12.3", name: "drawSVG", register: function register(e) {
                o = e, H()
